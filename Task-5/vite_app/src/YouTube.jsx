...
function YouTube (){
    return (
        ...
        <a href="#">
        <img alt="Nadir In The Go" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(2).png?raw=true" width="25"/>
        Nadir In The Go
        </a>
        <a href="#">
        <img alt="Coke Studio Bangla" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(1).png?raw=true" width="25"/>
        Coke Studio Bangla
        </a>
        <a href="#">
        <img alt="MKBHD" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(2).png?raw=true" width="25"/>
        MKBHD
        </a>
        <a href="#">
        <img alt="Figma" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(3).png?raw=true" width="25"/>
        Figma
        </a>
        <a href="#">
        <img alt="ATC Android ToTo Company" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(4).png?raw=true" width="25"/>
        ATC Android ToTo Company
        </a>
        <a href="#">
        <img alt="Alux.com" height="25" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/Ellipse%201%20(5).png?raw=true" width="25"/>
        ATC Android ToTo Company
        </a>
    </div>
